...
import '../widgets/build_text_home_page.dart';

class FemaleTeacherPage extends StatelessWidget {
  const FemaleTeacherPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const TextHomePageWidget(text: 'Female Teacher'),
        actions: const [
          Padding(
